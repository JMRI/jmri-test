 ...
 * @version $Revision$
 */
public class SRCPClientParserTest extends NbTestCase {

    public SRCPClientParserTest(String name) {
        super(name);
    }
    ...
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite(SRCPClientParserTest.class);
        return suite;
