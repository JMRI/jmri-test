...
public class LIUSBTest extends NbTestCase {
    ...
    public static NbTestSuite suite() {
        NbTestSuite suite = new NbTestSuite("jmri.jmrix.lenz.liusb.LIUSBTest");  // no tests in this class itself
        suite.addTest(new NbTestSuite(LIUSBAdapterTest.class));
        suite.addTest(new NbTestSuite(LIUSBXNetPacketizerTest.class));
        return suite;
    }
