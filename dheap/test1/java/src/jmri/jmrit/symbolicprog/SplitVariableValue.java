...
public class SplitVariableValue extends VariableValue
    ...
    void exitField() {
        ...
        if (_value != null && !oldContents.equals(_value.getText())) {
            int newVal = (textToValue(_value.getText()) - mOffset) / mFactor;
            int oldVal = (textToValue(oldContents) - mOffset) / mFactor;
            updatedTextField();
    ...
    void updatedTextField() {
        if (log.isDebugEnabled()) {
            log.debug("CV " + getCvNum() + "," + getSecondCvNum() + " enter updatedTextField in " + (this.getClass().getSimpleName()));
        }
        ...
        try {
            newEntry = textToValue(_value.getText());
    ...
    public int getIntValue() {
        return (textToValue(_value.getText()) - mOffset) / mFactor;
    }
    ...
    public void setValue(int value) {
        ...
        int oldVal;
        try {
            oldVal = (textToValue(_value.getText()) - mOffset) / mFactor;
        } catch (java.lang.NumberFormatException ex) {
            oldVal = -999;
        }
        if (log.isDebugEnabled()) {
        ...
        _value.setText(valueToText(value * mFactor + mOffset));
