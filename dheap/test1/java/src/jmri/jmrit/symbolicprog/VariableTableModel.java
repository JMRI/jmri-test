...
public class VariableTableModel extends AbstractTableModel implements ActionListener, PropertyChangeListener {
    ...
    public void setRow(int row, Element e) {
        ...
        } else if ((child = e.getChild("quadVal")) != null) {
            v = processQuadVal(child, CV, readOnly, infoOnly, writeOnly, name, comment, opsOnly, mask, item);

        } else if ((child = e.getChild("quadHexVal")) != null) {
            v = processQuadHexVal(child, CV, readOnly, infoOnly, writeOnly, name, comment, opsOnly, mask, item);
    ...
    protected VariableValue processSplitHexVal(Element child, String CV, boolean readOnly, boolean infoOnly, boolean writeOnly, String name, String comment, boolean opsOnly, String mask, String item) throws NumberFormatException {
        ...
        _cvModel.addCV("" + (highCV), readOnly, infoOnly, writeOnly); // ensure 2nd CV exists
        v = new SplitHexVariableValue(name, comment, "", readOnly, infoOnly, writeOnly, opsOnly, CV, mask, minVal, maxVal, _cvModel.allCvMap(), _status, item, highCV, factor, offset, uppermask);
        return v;
    }

    protected VariableValue processQuadVal(Element child, String CV, boolean readOnly, boolean infoOnly, boolean writeOnly, String name, String comment, boolean opsOnly, String mask, String item) throws NumberFormatException {
        VariableValue v;
        Attribute a;
        ...
        String secondCV = null;
        if ((a = child.getAttribute("secondCV")) != null) {
            secondCV = a.getValue();
            _cvModel.addCV("" + (secondCV), readOnly, infoOnly, writeOnly); // ensure CV exists
        }

        String thirdCV = null;
        if ((a = child.getAttribute("thirdCV")) != null) {
            thirdCV = a.getValue();
            _cvModel.addCV("" + (thirdCV), readOnly, infoOnly, writeOnly); // ensure CV exists
        }

        String fourthCV = null;
        if ( ((a = child.getAttribute("fourthCV")) != null) ||
            ((a = child.getAttribute("highCV")) != null) ) {
            fourthCV = a.getValue();
            _cvModel.addCV("" + (fourthCV), readOnly, infoOnly, writeOnly); // ensure CV exists
        }
        ...
        String secondMask = "VVVVVVVV";
        if ((a = child.getAttribute("secondMask")) != null) {
            secondMask = a.getValue();
        }

        String thirdMask = "VVVVVVVV";
        if ((a = child.getAttribute("thirdMask")) != null) {
            thirdMask = a.getValue();
        }

        String fourthMask = "VVVVVVVV";
        if ( ((a = child.getAttribute("fourthMask")) != null) ||
            ((a = child.getAttribute("upperMask")) != null) ||
            ((a = child.getAttribute("highMask")) != null) ) {
            fourthMask = a.getValue();
        }

        v = new QuadVariableValue(name, comment, "", readOnly, infoOnly, writeOnly, opsOnly, CV, mask, minVal, maxVal, _cvModel.allCvMap(), _status, item, secondCV, thirdCV, fourthCV, factor, offset, secondMask, thirdMask, fourthMask);
        return v;
    }

    protected VariableValue processQuadHexVal(Element child, String CV, boolean readOnly, boolean infoOnly, boolean writeOnly, String name, String comment, boolean opsOnly, String mask, String item) throws NumberFormatException {
        VariableValue v;
        Attribute a;
        ...
        v = new QuadHexVariableValue(name, comment, "", readOnly, infoOnly, writeOnly, opsOnly, CV, mask, minVal, maxVal, _cvModel.allCvMap(), _status, item, secondCV, thirdCV, fourthCV, factor, offset, secondMask, thirdMask, fourthMask);
        return v;
    }
