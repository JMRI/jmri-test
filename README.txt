...
## Tasks
Tasks for this effort are being tracked at [Trello](https://trello.com/b/UupW5EFW/jmri-4).
...
* __JMRI Core__ - this module contain the core JMRI code required to successfully run JMRI in a headless mode. It should be possible for the JMRI code to be broken into otherwise independent modules if they listen to the isStarted() and isShown() properties of this modules's JmriApplication class to inform them when the JMRI core is ready.
